...
function makeJsonNode(string $path, ?int $cycleId = null, int $signal = 10, ?int $cycleBoost = null, ?string $severity = null, ?int $connectionBoost = null, ?int $connections = null, ?int $baseSignal = null): array
{
    return [
        'path' => $path,
        'status' => 'modified',
