    ...
    for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class="file-row" data-node-id="' + n.id.replace(/"/g, '&quot;') + '">' +
        ...
        '<div class="file-col file-col-name">' +
          '<div class="file-name-main"><span class="file-domain-dot" style="background:' + (n.domainColor || '#8b949e') + '"></span><span class="file-name-text">' + n.id.replace(/</g, '&lt;') + '</span>' + (n.ext ? '<span class="file-ext-badge">.' + n.ext + '</span>' : '') + (n.watched ? ' <span style="color:#d29922;font-size:10px" title="Watched' + (n.watchReason ? ': ' + n.watchReason : '') + '">&#9670;</span>' : '') + '</div>' +
