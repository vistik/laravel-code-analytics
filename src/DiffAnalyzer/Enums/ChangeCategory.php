...
enum ChangeCategory: string
{
    ...
    case DB_SELECT_FIELD_ADDED = 'db_select_field_added';
    case DB_SELECT_FIELD_REMOVED = 'db_select_field_removed';
    case DB_CONDITION_ADDED = 'db_condition_added';
    case DB_CONDITION_REMOVED = 'db_condition_removed';
    case DB_ORDER_ADDED = 'db_order_added';
    case DB_ORDER_REMOVED = 'db_order_removed';
    case DB_JOIN_ADDED = 'db_join_added';
    case DB_JOIN_REMOVED = 'db_join_removed';
    case DEPENDENCY = 'dependency';
    case LARAVEL_CONFIG = 'laravel_config';
    case CIRCULAR_DEPENDENCY = 'circular_dependency';
    case COMPLEXITY = 'complexity';
    case SECURITY_ADVISORY = 'security_advisory';
    ...
    public function shortDescription(): string
    {
        return match ($this) {
            ...
            self::DB_SELECT_FIELD_ADDED => 'DB query select field additions',
            self::DB_SELECT_FIELD_REMOVED => 'DB query select field removals',
            self::DB_CONDITION_ADDED => 'DB query where condition additions',
            self::DB_CONDITION_REMOVED => 'DB query where condition removals',
            self::DB_ORDER_ADDED => 'DB query order-by additions',
            self::DB_ORDER_REMOVED => 'DB query order-by removals',
            self::DB_JOIN_ADDED => 'DB query join additions',
            self::DB_JOIN_REMOVED => 'DB query join removals',
            ...
            self::SECURITY_ADVISORY => 'Security advisories from composer audit',
        };
    }
}
