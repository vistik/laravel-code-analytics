...
class AnalyzeCode
{
    ...
    public function execute(
        ...
        if ($minSeverity !== null) {
            ['nodes' => $nodes, 'analysisData' => $analysisData, 'metricsData' => $metricsData, 'fileDiffs' => $fileDiffs]
                = (new MinSeverityFilter)->apply($nodes, $analysisData, $metricsData, $fileDiffs, $minSeverity);
